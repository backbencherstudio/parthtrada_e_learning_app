class BookExpertState{
  ...
  BookExpertState({this.isConfirmLoading = false, this.selectedDuration = 0, this.selectedSessionTime = 0, this.isMorningShift = true, this.isSuccessfullyBooked = false});

  BookExpertState copyWith({int? selectedDuration,
    int? selectedSessionTime,
    bool? isMorningShift,
    bool? isSuccessfullyBooked,
    bool? isConfirmLoading,
