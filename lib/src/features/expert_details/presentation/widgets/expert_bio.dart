...
class ExpertBio extends StatelessWidget{
  ...
  final String expertBio = "An experienced industry professional dedicated to helping students and early-career individuals with personalized career advice, skill-building, and growth strategies."
