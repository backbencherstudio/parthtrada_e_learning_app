...
import 'package:e_learning_app/src/features/profile/presentation/payment%20method/view/webview_screen.dart'
    show WebViewScreen, StripeWebViewScreen;
...
class _PayoutMethodScreenState extends ConsumerState<PayoutMethodScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Center(
        child:
            paymentState.isLoadingAccountStatus
                ...
                ? Column(
                  ...
                  children: [
                    ...
                    Text(
                      paymentState.errorMessageAccountStatus!.contains(
                            'rate limit',
                          )
  ...
  Widget _buildAccountStatusContent(
                  ...
                  try {
                    ...
                    if (newState.isSuccessCreateAccount != true) {
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(
                          content: Text(
                            newState.errorMessageCreateAccount ??
                    ...
                    if (updatedState.onboardingUrl != null) {
                      ...
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder:
                              (_) => StripeWebViewScreen(
                                url: updatedState.onboardingUrl!,
                              ),
                        ),
                      );
                    } else {
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(
                          content: Text(
                            updatedState.errorMessageOnboardingUrl ??
                                'Failed to get onboarding URL',
                          ),
                        ),
                      );
                    }
