...
class _UserProfileState extends ConsumerState<UserProfile> {
  ...
  Widget build(BuildContext context) {
    ...
    if (profileState.isProfileSuccess &&
        profileState.profileResponseData.data?.meta != null) {
      _professionController.text =
          profileState.profileResponseData.data!.meta!.profession ?? '';
      _organizationController.text =
          profileState.profileResponseData.data!.meta!.organization ?? '';
      _locationController.text =
          profileState.profileResponseData.data!.meta!.location ?? '';
      _bioController.text =
          profileState.profileResponseData.data!.meta!.description ?? '';
    }
                ...
                child: SingleChildScrollView(
                  child: Column(
                    children: [
                      ...
                      Headers(
                        imageUrl:
                            profileState.profileResponseData.data?.image != null
                      ...
                      Row(
                        children: [
                          ...
                          Mybutton(
                            ...
                            text:
                                profileState.isUpdateProfileLoading
                                    ? "Updating..."
                                    : "Save",
                            onTap: () async {
