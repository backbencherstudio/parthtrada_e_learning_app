...
import 'package:e_learning_app/src/features/profile/presentation/be%20a%20expert/sub%20bottomsheets/select_skills_sheet.dart';
...
class _BeExpertBottomSheetState extends ConsumerState<BeExpertBottomSheet> {
  ...
  void initState() {
    ...
    // Initialize description and hourly rate
    if (profileData.data?.meta != null) {
      ...
      if (meta.hourlyRate != null) {
        hourlyRateController.text = meta.hourlyRate!.toString();
      }
      // Initialize skills in a post-frame callback to avoid modifying provider during build
      if (meta.skills != null && meta.skills!.isNotEmpty) {
        WidgetsBinding.instance.addPostFrameCallback((_) {
          final notifier = ref.read(skillSelectionProvider.notifier);
          for (var skill in meta.skills!) {
            notifier.toggle(skill);
          }
        });
      }
    }
              ...
              children: [
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                    hintText: selectedSkills.isEmpty
                        ? "Select Skills"
                        : selectedSkills.join(", "),
